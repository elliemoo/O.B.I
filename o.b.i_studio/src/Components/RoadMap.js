          ...
          <div className='timeline-container'>
            ...
            <div className='timeline'>
              ...
              <div className='timeline-content'>
                <h1> Birth of Zoth Lore/Sin's Taking Over Lore </h1>
                
              </div>
          
              <div className='timeline-content'>
                <h1> WL/OG Teaching Master Classes</h1>
                
              </div>
            
              <div className='timeline-content'>
                <h1> Obi's Mental Health Cast </h1>
                
              </div>
          
              <div className='timeline-content'>
                <h1> Core Team AMA/Full Team Introduction</h1>
...
//       <Container className='card-container'>
//         <Card.Title><h1> 🌋 Hellion's Gate Opening 🌋</h1></Card.Title><br></br>
...
//             Animation Reveal/Presentation's<br></br>
//             Semi-Full Soundtrack Reveal!<br></br>
//             Monthly Development Presentation<br></br>
...
//           Airdrop Item Creation Presentation<br></br>
